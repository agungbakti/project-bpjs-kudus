...
<head>
  ...
  <link rel="stylesheet" href="faskes3/style/index.css">
...
<body>
  <?php include "faskes3/dashboard/navbar.php"; ?>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-between">
        ...
        <div class="teks col-md-6 mb-3 content-box text-white" style="text-align: justify;">
          ...
          <p style="font-family: Inter, sans-serif;" class="lead fw-semibold">Akses nomer antrian dan manajemen data fasilitas
            kesehatan anda secara mudah dan cepat yang bisa
            diakses dimana saja</p>
          <a href="login.php" class="btn btn-primary">Login Disini</a>
        </div>
