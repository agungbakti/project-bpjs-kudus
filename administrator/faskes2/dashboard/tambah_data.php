                ...
                <form action="" method="post" style=" max-height: 465px; overflow-x: auto; overflow-y: auto;">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nik" id="nik" required minlength="16" maxlength="16"
                                pattern="[0-9]{16}" autocomplete="off" placeholder="masukan nik" class="form-control">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3 d-flex" style="justify-content: space-evenly;">
                            <a href="admin.php" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Kembali</a>
                            <button name="submit" type="submit" class="btn btn-success"><i
                                    class="bi bi-check-circle"></i>Submit</button>
                        </div>
                </form>
            </div>
        </div>
