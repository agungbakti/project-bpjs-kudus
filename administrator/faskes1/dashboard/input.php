...
if (isset($_POST['submit'])) {
    ...
    if ($result > 0) {
        ...
        document.location.href = 'faskes.php';
        </script>
        ";
    } elseif ($result == -1) {
        echo "
        ...
        <div class="container py-5">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h4 class="text-center fs-5 mb-0"><i class="bi bi-pencil-square-me-2"></i>Formulir Pembuatan Akun
                        Mobile JKN / Perubahan Data Nomor HP</h4>
                </div>
                    ...
                    <form action="" method="post" style=" max-height: 465px; overflow-x: auto; overflow-y: auto;">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" name="tanggal" id="tanggal" class="form-control" min="<?= $todayDate ?>" required>
                            </div>
                        </div>
