...
<body>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-between">
        ...
        <div class="teks col-md-6 mb-3 content-box text-white" style="text-align: justify;">
          <p style="font-family: Inter, sans-serif" class="lead fw-semibold"><b>Layanan Sistem Booking Antrean Online Di BPJS Kesehatan Kantor Cabang Kudus</b></p>
          <p style="font-family: Inter, sans-serif;" class="lead fw-semibold">Tentukan jam booking dan dapatkan nomer antrian anda secara mudah dan cepat yang bisa diakses dimana saja</p>
          <a href="booking.php" class="btn btn-primary">Ambil Antrean</a>
        </div>
  ...
  <!-- galeri -->
  <section id="galeri">
    <div class="container" style="padding: 40px;" id="galeri">
      ...
      <div id="carouselExampleDark" class="carousel carousel-dark slide carousel-fade">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active" data-bs-interval="10000">
            <img src="assets/gambar1.jpeg" class="d-block w-100 rounded shadow" alt="...">
          </div>
          <div class="carousel-item" data-bs-interval="2000">
            <img src="assets/gambar2.jpeg" class="d-block w-100 rounded shadow" alt="...">
          </div>
          <div class="carousel-item">
            <img src="assets/gambar3.jpeg" class="d-block w-100 rounded shadow" alt="...">
          </div>
          <div class="carousel-item">
            <img src="assets/gambar4.jpeg" class="d-block w-100 rounded shadow" alt="...">
          </div>
          <div class="carousel-item">
            <img src="assets/gambar5.jpeg" class="d-block w-100 rounded shadow" alt="...">
          </div>
          <div class="carousel-item">
            <img src="assets/gambar6.jpeg" class="d-block w-100 rounded shadow" alt="...">
          </div>
        </div>
